...
const gradientBg21 = ctx2.createLinearGradient(0, 0, 0, 228);
gradientBg21.addColorStop(0, "#F7D2FF");
gradientBg21.addColorStop(1, "#FF82E2");

const gradientBg31 = ctx2.createLinearGradient(0, 0, 0, 228);
gradientBg31.addColorStop(0, "#C6AEFF");
...
const myChart2 = new Chart(ctx2, {
    ...
    options: {
        ...
        plugins: {
            title: {
                display: false,
                text: 'Gráfico da performance da escola',
                font: {
                    size: 18,
                    family: 'Poppins',
                    weight: 600
