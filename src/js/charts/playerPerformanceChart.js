...
const getOrCreateTooltip21 = (chart) => {
...
const externalTooltipHandler21 = (context) => {
    // Tooltip Element
    const {chart, tooltip} = context;
    const tooltipEl = getOrCreateTooltip21(chart);
...
const gradientBg221 = ctx21.createLinearGradient(0, 0, 0, 228);
gradientBg221.addColorStop(0, "#F7D2FF");
gradientBg221.addColorStop(1, "#FF82E2");

const gradientBg222 = ctx2.createLinearGradient(0, 0, 0, 228);
gradientBg222.addColorStop(0, "#C6AEFF");
gradientBg222.addColorStop(1, "#7C37FA");
...
const myChart21 = new Chart(ctx21, {
    ...
    data: {
        ...
        datasets: [
            {
                label: 'SLP',
                data: [2100, 2100, 1800, 1000, 2100, 1000, 2000, 6000, 10000],
                backgroundColor: gradientBg221,
                borderRadius: 9,
                /* barThickness: 29, */
            ...
            {
                label: 'AXS',
                data: [2000, 1500, 5000, 500, 2000, 1500, 1800, 4500, 5000],
                backgroundColor: gradientBg222,
                borderRadius: 9,
                /* barThickness: 29, */
                categoryPercentage: 0.8,
                barPercentage: 0.8
    ...
    options: {
        ...
        plugins: {
            ...
            tooltip:{
                enabled: false,
                position: 'nearest',
                external: externalTooltipHandler21 
            }
        },
        scales: {
            y: {
